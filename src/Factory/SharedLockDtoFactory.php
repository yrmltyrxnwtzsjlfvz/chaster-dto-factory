...
final class SharedLockDtoFactory extends ObjectFactory
{
    ...
    protected function defaults(): array|callable
    {
        ...
        return [
            ...
            'password' => $requirePassword ? self::faker()->password() : null,
            ...
            //'user' => UserFactory::new(['role' => self::faker()->optional(.75)->randomElement([ProfileRole::KEYHOLDER, ProfileRole::SWITCH, ProfileRole::UNSPECIFIED])]),
    ...
    {
        return $this
            ->afterInstantiate(function (SharedLockDto $sharedLock): void {
